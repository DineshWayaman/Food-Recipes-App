...
public class RicePageRecyclerViewAdapter extends RecyclerView.Adapter<RicePageRecyclerViewAdapter.MyViewHolder> {

    private Context mContext ;
    private List<RiceAnime> mData ;
    RequestOptions option;

    public RicePageRecyclerViewAdapter(Context mContext, List<RiceAnime> mData){
