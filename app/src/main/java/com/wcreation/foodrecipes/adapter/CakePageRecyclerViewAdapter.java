...
public class CakePageRecyclerViewAdapter extends RecyclerView.Adapter<CakePageRecyclerViewAdapter.MyViewHolder> {

    private Context mContext ;
    private List<CakeAnime> mData ;
    RequestOptions option;

    public CakePageRecyclerViewAdapter(Context mContext, List<CakeAnime> mData){
