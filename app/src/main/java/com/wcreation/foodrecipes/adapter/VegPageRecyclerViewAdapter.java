...
public class VegPageRecyclerViewAdapter extends RecyclerView.Adapter<VegPageRecyclerViewAdapter.MyViewHolder> {

    private Context mContext ;
    private List<VegAnime> mData ;
    RequestOptions option;

    public VegPageRecyclerViewAdapter(Context mContext, List<VegAnime> mData){
