...
public class MeatPageRecyclerViewAdapter extends RecyclerView.Adapter<MeatPageRecyclerViewAdapter.MyViewHolder> {

    private Context mContext ;
    private List<MeatAnime> mData ;
    RequestOptions option;

    public MeatPageRecyclerViewAdapter(Context mContext, List<MeatAnime> mData){
